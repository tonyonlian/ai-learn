 ...
 */
function formatMarkdown(query, data, limit, offset) {
 ...
 */
function prepareStructuredOutput(data, limit, offset) {
    const organicResults = data.organic_results || [];
    const total = organicResults.length;
 ...
 */
export async function baiduSearchTool(params) {
    try {
        ...
        const structuredOutput = prepareStructuredOutput(data, params.limit, params.offset);
