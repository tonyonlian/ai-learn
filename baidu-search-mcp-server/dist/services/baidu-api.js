...
import { API_BASE_URL, REQUEST_TIMEOUT, LANGUAGE_MAP, ENV } from '../constants.js';
/**
 ...
 */
function mapLanguageToApiParam(language) {
...
export function validateApiKey() {
    ...
    if (!apiKey) {
        throw new Error(`ERROR: ${ENV.API_KEY} environment variable is required. ` +
 ...
 */
export async function baiduSearch(query, options) {
    ...
    return makeApiRequest('', 'GET', params);
}
//# sourceMappingURL=baidu-api.js.map